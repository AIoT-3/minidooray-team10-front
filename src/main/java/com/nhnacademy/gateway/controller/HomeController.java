...
//        MemberNameResponse nameResponse = accountApiClient.getMemberName();
//        List<ProjectResponse> responses = projectApiClient.getProjectsByMemberId();
//
//        model.addAttribute("projects", responses);
//        model.addAttribute("name", nameResponse.name());
//        return "index";
//    }
//
//}
